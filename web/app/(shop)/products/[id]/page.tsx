                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 bg-(--color-primary-light) rounded-full flex items-center justify-center text-xs font-bold text-(--color-primary)">
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Left — Image */}
            <div className="bg-linear-to-br from-gray-100 to-gray-50 rounded-3xl h-80 sm:h-112 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div>
                <span className="px-3 py-1 bg-(--color-primary-light) text-(--color-primary) rounded-full text-xs font-medium capitalize">
                  {product.category.replace("-", " ")}
                </span>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-3.5 rounded-full font-semibold transition-all flex items-center justify-center gap-2 bg-(--color-primary) text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {similarProducts.map((p) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold text-gray-900 group-hover:text-(--color-primary) truncate">
                      {p.name}
                    </p>
