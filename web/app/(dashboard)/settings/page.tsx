          ...
          <div className="bg-white rounded-2xl shadow-sm mb-6 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-4 mb-2">
                <div className="w-16 h-16 rounded-full bg-(--color-primary) text-white flex items-center justify-center text-2xl font-bold">
              ...
              {editMode ? (
                <div className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-(--color-primary)"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <button
                    onClick={handleSave}
                    className="px-6 py-2.5 bg-(--color-primary) text-white rounded-full text-sm font-medium hover:opacity-90 transition-colors"
                  >
                    Save Changes
                  </button>
                </div>
