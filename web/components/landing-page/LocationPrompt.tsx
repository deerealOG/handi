        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={detecting}
              className="flex-1 bg-(--color-primary) text-white py-2 rounded-full text-xs font-semibold hover:bg-(--color-primary-dark) transition-colors disabled:opacity-60"
            >
