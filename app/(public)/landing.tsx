...
import { EnhancedArtisanCard, ArtisanData } from "../components/EnhancedArtisanCard";
          ...
          >
            {filteredProviders.map((provider) => {
              const artisanData: ArtisanData = {
                id: provider.id,
                name: provider.name,
                skill: provider.category,
                price: provider.price,
                rating: provider.rating,
                reviews: provider.reviews,
                distance: provider.location,
                verificationLevel: provider.badge === "Top Rated" || provider.badge === "Verified" ? "verified" : provider.badge === "Premium" ? "certified" : "none",
                isEmergencyAvailable: provider.isOnline,
              };
              return (
                <EnhancedArtisanCard
                  key={provider.id}
