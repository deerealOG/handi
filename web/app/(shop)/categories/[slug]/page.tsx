...
export default async function CategoryPage({
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="bg-(--color-primary) py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {category.services.map((service) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-(--color-primary-light) flex items-center justify-center shrink-0">
                  <IconComponent
                    size={20}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SAMPLE_PROVIDERS.map((provider) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 text-sm text-(--color-muted) mb-2">
                  <MapPin size={14} />
                  {provider.location}
                </div>
                ...
                <Link
                  ...
                  className="mt-4 block w-full text-center py-2 bg-(--color-primary) text-white rounded-full text-sm font-medium hover:bg-(--color-primary-dark) transition-colors"
                >
                  View Profile
                </Link>
              </div>
          ...
          <div className="text-center mt-8">
            <Link
              ...
              className="inline-flex items-center text-(--color-primary) font-medium hover:underline"
            >
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center h-12 px-8 bg-(--color-primary) text-white rounded-[50px] font-medium hover:bg-(--color-primary-dark) transition-colors"
          >
