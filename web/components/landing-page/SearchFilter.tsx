//components/layout/SearchFilter.tsx
  ...
  return (
    <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-xl border border-gray-100 p-5 z-50 animate-fadeIn">
      ...
      <div className="flex items-center justify-end gap-3 mt-5 pt-4 border-t border-gray-100">
        ...
        <button
          onClick={handleApply}
          className="px-6 py-2.5 bg-(--color-primary) text-white text-sm font-semibold rounded-full hover:bg-(--color-primary-dark) transition-colors"
        >
          Apply Filters
        </button>
      </div>
