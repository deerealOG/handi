    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-(--color-muted) text-center mb-12 max-w-xl mx-auto">
            ...
            {POPULAR_TOPICS.map((topic) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-(--color-primary-light) flex items-center justify-center shrink-0 group-hover:bg-(--color-primary) transition-colors">
                    <topic.icon
                      size={24}
                  ...
                  <div>
                    <h3 className="font-heading font-semibold text-lg mb-2 group-hover:text-(--color-primary) transition-colors">
                      {topic.title}
                    </h3>
            ...
            {PROVIDER_GUIDELINES.map((guideline) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center mb-4 shrink-0">
                  <CheckCircle2 className="text-(--color-primary) w-5 h-5" />
                </div>
      ...
      <section className="py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 h-12 px-8 rounded-[50px] border-2 border-(--color-primary) text-(--color-primary) font-medium hover:bg-(--color-primary-light) transition-colors"
            >
